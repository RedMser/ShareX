...
namespace ShareX
{
    ...
    public class TaskSettingsAdvanced
    {
        ...
        [Category("Capture"), DefaultValue(true), Description("Ask whether to close a region capture or image editor whenever it has unsaved changes (such as annotations).")]
